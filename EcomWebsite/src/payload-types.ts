...
export interface Product {
  ...
  priceInLBPEnabled?: boolean | null;
  priceInLBP?: number | null;
  ...
  sku?: string | null;
  /**
   * Original product URL (scraper source).
   */
...
export interface ShopSetting {
  ...
  title?: string | null;
  /**
   * Optional text shown under the shop heading.
   */
  intro?: string | null;
  /**
   * Pinned to the top of the shop (when no search/category filter).
   */
  featuredProducts?: (number | Product)[] | null;
  /**
   * Sort choices shown to shoppers.
   */
  sortOptions?:
    | {
        label: string;
