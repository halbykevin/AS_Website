...
// A comprehensive list of nations (FIFA members + others). Sorted by name for the
// admin dropdown. Codes are ISO 3166-1 alpha-2 (lowercase); the four UK home
// nations use flagcdn's `gb-eng` / `gb-sct` / `gb-wls` / `gb-nir` codes.
