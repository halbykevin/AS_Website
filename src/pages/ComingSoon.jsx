    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white px-5 py-12 text-center sm:px-8">
      ...
      <main className="relative z-10 flex w-full max-w-xl flex-col items-center">
        ...
        <p className="mt-4 max-w-md text-base leading-relaxed text-as-charcoal/60 sm:text-lg">
          {brand.tagline} We&rsquo;re building something new — in the meantime,
...
function ContactRow({ href, label, value, icon, external }) {
  return (
    <a
      href={href}
    ...
    >
      ...
      <span className="min-w-0">
        <span className="block text-xs font-medium uppercase tracking-wider text-as-charcoal/40">{label}</span>
        <span className="block truncate text-sm font-semibold text-as-charcoal">{value}</span>
      </span>
    </a>
  )
}
