// Geometry for the Daily Spin wheel. This is a deliberate copy of
// `as_store/src/lib/wheel.js` — the two packages don't share code, and the
// admin's preview must land on the same slice the customer's wheel does, so the
// maths has to be identical. Change one, change the other.
//
