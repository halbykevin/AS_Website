...
export const hero = {
  ...
  subtitle: 'From the latest technology to unforgettable live events, AS Company brings people together. Discover what we do and reserve your spot at our upcoming events.'
};

export const services = {
  heading: 'What We Do',
  subheading: 'A market leader in telecommunication and electronics, delivering products, services and experiences across Lebanon.',
  items: [
...
export const whatWeDo = {
  ...
  solutionsIntro: 'At Absolute Solution, we believe in a dynamic approach that aligns with your business objectives. Your success is a crucial factor in our growth strategy; therefore, we work in synergy with your organization to deliver measurable results and sustainable growth.',
  visionHeading: 'Our Vision',
  vision: 'We are focused on delivering world-class Technology, Security, Automation, and Business Solutions. Our vision is to modernize and redefine the industry while continuously improving the customer experience to exceed expectations.',
  missionHeading: 'Our Mission',
  mission: 'Our mission is to deliver comprehensive and affordable solutions that enable SMEs and enterprises to operate efficiently, securely, and productively.',
...
export const solutions = [
  {
    ...
    outro: '',
    items: [{ title: 'Network Infrastructure' }, { title: 'Network Security' }, { title: 'IT Security Solutions' }, { title: 'Voice Solutions' }, { title: 'Structured Cabling' }]
  },
  {
    ...
    items: [{ title: 'Virtualization' }, { title: 'Cloud Solutions' }, { title: 'Servers & Storage' }, { title: 'System Infrastructure' }, { title: 'Data Backup & Disaster Recovery' }, { title: 'Business Continuity Solutions' }]
  },
  {
  ...
  },
  {
    ...
    items: [{ title: 'Lighting' }, { title: 'Climate Control' }, { title: 'Security Systems' }, { title: 'Audio & Video Systems' }, { title: 'Door Access' }, { title: 'Remote Monitoring' }]
  },
  {
    ...
    items: [{ title: 'Filing Systems' }, { title: 'Desk Accessories' }, { title: 'Writing Instruments' }, { title: 'Papers & Office Supplies' }, { title: 'Computer Accessories' }, { title: 'Ink & Toner Supplies' }]
  },
  {
    ...
    items: [{ title: 'Maintenance Contracts' }, { title: 'Onsite Support' }, { title: 'Remote Support' }, { title: 'On-Demand Support' }, { title: 'IT Consultancy' }, { title: 'Technical Assistance' }]
  }
];
...
export const about = {
  ...
  body: ['Absolute Solutions SAL (AS Company) has been a market leader in telecommunication and electronics in Lebanon since 2008.', 'We combine a passion for technology with a commitment to bringing people together — whether through the products we sell or the live events we power.'],
  stats: [
