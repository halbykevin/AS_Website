...
export default function ContactForm() {
  ...
  if (status === "sent") {
    return (
      <div className="flex flex-col items-center gap-3 rounded-[28px] border border-as-ink/10 bg-white p-10 text-center">
        ...
        <h3 className="text-xl font-semibold tracking-apple text-as-ink">
          Message sent
        </h3>
        <p className="text-as-ink/60">
  ...
  return (
    <form
      onSubmit={submit}
      className="space-y-4 rounded-[28px] border border-as-ink/10 bg-white p-6 sm:p-8"
    >
