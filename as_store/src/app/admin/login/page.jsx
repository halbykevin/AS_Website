...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-admin-invert px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-white/10 bg-admin-surface p-8 shadow-2xl">
        <div className="mb-6 flex flex-col items-center">
          <span className="rounded-lg bg-admin-invert px-3 py-2">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/as-store-logo.webp" alt="AS Store" width={300} height={200} className="h-7 w-auto" />
          </span>
          <h1 className="mt-4 text-xl font-bold text-admin-text">AS Store CMS</h1>
          <p className="mt-1 text-sm text-admin-text/50">Sign in to manage the store</p>
        </div>
